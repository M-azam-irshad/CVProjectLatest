...
// const ExperienceInfo = ({ experience, setExperience }) => {
//   const handleChange = (field, value) => {
//     setExperience(prev => ({
//       ...prev,
//       [field]: value
...
//           <input
//             type="text"
//             value={experience.yearsInService}
...
// // Preview Component - Professional Resume Layout
...
//     school: "e.g XYZ University",
//     graduationYear: "e.g 2023",
//     description: "e.g Relevant coursework: Data Structures, Algorithms"
//   });
...
//         <button 
//           className="fixed top-4 right-4 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-2 px-6 rounded-lg shadow-lg transition-all duration-200 transform hover:scale-105 z-10"
...
//             <div>
//               <h2 className="text-2xl font-bold text-gray-800 mb-4">Experience Information</h2>
//               <ExperienceInfo experience={experience} setExperience={setExperience} />
//             </div>
            
//             <div>
//               <h2 className="text-2xl font-bold text-gray-800 mb-4">Education Information</h2>
//               <EducationInfo education={education} setEducation={setEducation} />
//             </div>
//           </div>
//         ) : (
//           <Preview education={education} personalInfo={personalInfo} experience={experience} />
//         )}
//       </div>
//     </div>
//   );
