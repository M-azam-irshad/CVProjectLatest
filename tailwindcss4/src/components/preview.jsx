...
export default function Preview({personalInfo, experience}) {
     return (
      <>
    <div className="min-h-2 flex items-center justify-center p-4 w-[60vw] min-w-[350px] max-w-[700px] p-5 mx-auto mt-[5vh]" id="main-container">
